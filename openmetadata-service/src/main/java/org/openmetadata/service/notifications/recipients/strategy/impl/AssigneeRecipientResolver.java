...
public class AssigneeRecipientResolver implements RecipientResolutionStrategy {
  ...
  public Set<Recipient> resolve(
    ...
    try {
      ...
      // Add direct assignees from task
      return new HashSet<>(resolveDirectAssignees(thread.getTask().getAssignees(), destination));
  ...
  private Set<Recipient> resolveDirectAssignees(
